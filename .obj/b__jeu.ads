...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#3f6db6f7#;
   ...
   u00130 : constant Version_32 := 16#0b68e88b#;
   pragma Export (C, u00130, "pack_demineurB");
   u00131 : constant Version_32 := 16#a18b5af8#;
   pragma Export (C, u00131, "pack_demineurS");
   u00132 : constant Version_32 := 16#51e8f7c0#;
   pragma Export (C, u00132, "aleatoireB");
   u00133 : constant Version_32 := 16#5ebf4653#;
   pragma Export (C, u00133, "aleatoireS");
   u00134 : constant Version_32 := 16#d9e9756e#;
   pragma Export (C, u00134, "calendarS");
   u00135 : constant Version_32 := 16#da9e3f22#;
   pragma Export (C, u00135, "ada__calendarB");
   u00136 : constant Version_32 := 16#8324cd02#;
   pragma Export (C, u00136, "ada__calendarS");
   u00137 : constant Version_32 := 16#307180be#;
   pragma Export (C, u00137, "system__os_primitivesB");
   u00138 : constant Version_32 := 16#a527f3eb#;
   pragma Export (C, u00138, "system__os_primitivesS");
   u00139 : constant Version_32 := 16#92ebd951#;
   pragma Export (C, u00139, "system__arith_64B");
   u00140 : constant Version_32 := 16#8e65a9dc#;
   pragma Export (C, u00140, "system__arith_64S");
   u00141 : constant Version_32 := 16#f2c63a02#;
   pragma Export (C, u00141, "ada__numericsS");
   u00142 : constant Version_32 := 16#174f5472#;
   pragma Export (C, u00142, "ada__numerics__big_numbersS");
   u00143 : constant Version_32 := 16#287108c1#;
   pragma Export (C, u00143, "es_fichierB");
   u00144 : constant Version_32 := 16#2a0bd5f5#;
   pragma Export (C, u00144, "es_fichierS");
   u00145 : constant Version_32 := 16#8b07c00c#;
   pragma Export (C, u00145, "ada__directoriesB");
   u00146 : constant Version_32 := 16#62239e2c#;
   pragma Export (C, u00146, "ada__directoriesS");
   u00147 : constant Version_32 := 16#de53e0a3#;
   pragma Export (C, u00147, "ada__containers__helpersB");
   u00148 : constant Version_32 := 16#229b07a5#;
   pragma Export (C, u00148, "ada__containers__helpersS");
   u00149 : constant Version_32 := 16#a8ed4e2b#;
   pragma Export (C, u00149, "system__atomic_countersB");
   u00150 : constant Version_32 := 16#7ec279de#;
   pragma Export (C, u00150, "system__atomic_countersS");
   u00151 : constant Version_32 := 16#f2ee0adc#;
   ...
   u00153 : constant Version_32 := 16#ab4ad33a#;
   ...
   u00172 : constant Version_32 := 16#32fdb361#;
   pragma Export (C, u00172, "system__file_attributesS");
   u00173 : constant Version_32 := 16#09793772#;
   pragma Export (C, u00173, "system__os_constantsS");
   u00174 : constant Version_32 := 16#ee52fa88#;
   pragma Export (C, u00174, "system__finalization_mastersB");
   u00175 : constant Version_32 := 16#2489a36e#;
   ...
   u00177 : constant Version_32 := 16#99e1245a#;
   pragma Export (C, u00177, "system__storage_poolsS");
   u00178 : constant Version_32 := 16#8f8e85c2#;
   pragma Export (C, u00178, "system__regexpB");
   u00179 : constant Version_32 := 16#81e831d1#;
   pragma Export (C, u00179, "system__regexpS");
   u00180 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00180, "ada__float_text_ioB");
   u00181 : constant Version_32 := 16#495f738b#;
   pragma Export (C, u00181, "ada__float_text_ioS");
   u00182 : constant Version_32 := 16#a621ddec#;
   pragma Export (C, u00182, "system__img_fltS");
   u00183 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00183, "system__float_controlB");
   u00184 : constant Version_32 := 16#4226d521#;
   pragma Export (C, u00184, "system__float_controlS");
   u00185 : constant Version_32 := 16#2549028f#;
   pragma Export (C, u00185, "system__img_utilB");
   u00186 : constant Version_32 := 16#c9a0e932#;
   pragma Export (C, u00186, "system__img_utilS");
   u00187 : constant Version_32 := 16#7a258c58#;
   pragma Export (C, u00187, "system__powten_fltS");
   u00188 : constant Version_32 := 16#b21210e0#;
   pragma Export (C, u00188, "system__img_lfltS");
   u00189 : constant Version_32 := 16#ea896312#;
   pragma Export (C, u00189, "system__img_lluS");
   u00190 : constant Version_32 := 16#a1d642dc#;
   pragma Export (C, u00190, "system__powten_lfltS");
   u00191 : constant Version_32 := 16#ee24b312#;
   pragma Export (C, u00191, "system__img_llfS");
   u00192 : constant Version_32 := 16#9dd1b61e#;
   pragma Export (C, u00192, "system__powten_llfS");
   u00193 : constant Version_32 := 16#daeb2f58#;
   pragma Export (C, u00193, "system__val_fltS");
   u00194 : constant Version_32 := 16#07cab9e4#;
   pragma Export (C, u00194, "system__exn_fltS");
   u00195 : constant Version_32 := 16#7f0e6534#;
   pragma Export (C, u00195, "system__val_lfltS");
   u00196 : constant Version_32 := 16#b98b583d#;
   pragma Export (C, u00196, "system__exn_lfltS");
   u00197 : constant Version_32 := 16#241739fa#;
   pragma Export (C, u00197, "system__val_llfS");
   u00198 : constant Version_32 := 16#9425984d#;
   pragma Export (C, u00198, "system__exn_llfS");
   u00199 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00199, "ada__integer_text_ioB");
   u00200 : constant Version_32 := 16#5e9ebd8f#;
   pragma Export (C, u00200, "ada__integer_text_ioS");
   u00201 : constant Version_32 := 16#6b2d15e3#;
   pragma Export (C, u00201, "system__img_biuS");
   u00202 : constant Version_32 := 16#2673d23d#;
   pragma Export (C, u00202, "system__img_llbS");
   u00203 : constant Version_32 := 16#98c6c945#;
   pragma Export (C, u00203, "system__img_lliS");
   u00204 : constant Version_32 := 16#5182274f#;
   pragma Export (C, u00204, "system__img_lllbS");
   u00205 : constant Version_32 := 16#f316ccbd#;
   pragma Export (C, u00205, "system__img_llliS");
   u00206 : constant Version_32 := 16#5bf63e43#;
   pragma Export (C, u00206, "system__img_lllwS");
   u00207 : constant Version_32 := 16#7a41a736#;
   pragma Export (C, u00207, "system__img_llwS");
   u00208 : constant Version_32 := 16#54f7aed1#;
   pragma Export (C, u00208, "system__img_wiuS");
   u00209 : constant Version_32 := 16#40199964#;
   pragma Export (C, u00209, "system__val_intS");
   u00210 : constant Version_32 := 16#5b7e5917#;
   pragma Export (C, u00210, "system__val_unsS");
   u00211 : constant Version_32 := 16#3738e9f5#;
   pragma Export (C, u00211, "system__val_llliS");
   u00212 : constant Version_32 := 16#4f0fea27#;
   pragma Export (C, u00212, "system__val_llluS");
