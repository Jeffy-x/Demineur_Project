...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_enregistrer_liste_sauvegardes" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2639fa19#;
   pragma Export (C, u00001, "test_enregistrer_liste_sauvegardesB");
   ...
   --  pack_demineur%s
   --  pack_demineur%b
   --  test_enregistrer_liste_sauvegardes%b
