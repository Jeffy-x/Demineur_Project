...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_demineur_v1_00" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d23456bc#;
   pragma Export (C, u00001, "demineur_v1_00B");
   ...
   u00126 : constant Version_32 := 16#25bef3ec#;
   pragma Export (C, u00126, "ada__text_io__enumeration_auxB");
   u00127 : constant Version_32 := 16#b431bcf1#;
   pragma Export (C, u00127, "ada__text_io__enumeration_auxS");
   ...
   u00130 : constant Version_32 := 16#287108c1#;
   pragma Export (C, u00130, "es_fichierB");
   u00131 : constant Version_32 := 16#2a0bd5f5#;
   pragma Export (C, u00131, "es_fichierS");
   u00132 : constant Version_32 := 16#8b07c00c#;
   pragma Export (C, u00132, "ada__directoriesB");
   u00133 : constant Version_32 := 16#62239e2c#;
   pragma Export (C, u00133, "ada__directoriesS");
   u00134 : constant Version_32 := 16#da9e3f22#;
   pragma Export (C, u00134, "ada__calendarB");
   u00135 : constant Version_32 := 16#8324cd02#;
   pragma Export (C, u00135, "ada__calendarS");
   u00136 : constant Version_32 := 16#307180be#;
   pragma Export (C, u00136, "system__os_primitivesB");
   u00137 : constant Version_32 := 16#a527f3eb#;
   pragma Export (C, u00137, "system__os_primitivesS");
   u00138 : constant Version_32 := 16#de53e0a3#;
   pragma Export (C, u00138, "ada__containers__helpersB");
   u00139 : constant Version_32 := 16#229b07a5#;
   pragma Export (C, u00139, "ada__containers__helpersS");
   u00140 : constant Version_32 := 16#a8ed4e2b#;
   pragma Export (C, u00140, "system__atomic_countersB");
   u00141 : constant Version_32 := 16#7ec279de#;
   pragma Export (C, u00141, "system__atomic_countersS");
   u00142 : constant Version_32 := 16#f2ee0adc#;
   pragma Export (C, u00142, "ada__directories__hierarchical_file_namesB");
   u00143 : constant Version_32 := 16#34d5eeb2#;
   pragma Export (C, u00143, "ada__directories__hierarchical_file_namesS");
   u00144 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00144, "ada__directories__validityB");
   u00145 : constant Version_32 := 16#0877bcae#;
   pragma Export (C, u00145, "ada__directories__validityS");
   u00146 : constant Version_32 := 16#091deb62#;
   pragma Export (C, u00146, "ada__strings__fixedB");
   u00147 : constant Version_32 := 16#780cfb01#;
   pragma Export (C, u00147, "ada__strings__fixedS");
   u00148 : constant Version_32 := 16#5a763444#;
   pragma Export (C, u00148, "ada__strings__searchB");
   u00149 : constant Version_32 := 16#dcefc5ee#;
   pragma Export (C, u00149, "ada__strings__searchS");
   u00150 : constant Version_32 := 16#cf7bfc56#;
   pragma Export (C, u00150, "ada__strings__unboundedB");
   u00151 : constant Version_32 := 16#90de6517#;
   pragma Export (C, u00151, "ada__strings__unboundedS");
   u00152 : constant Version_32 := 16#190570e0#;
   pragma Export (C, u00152, "system__compare_array_unsigned_8B");
   u00153 : constant Version_32 := 16#323c087e#;
   ...
   u00155 : constant Version_32 := 16#dceebabd#;
   ...
   u00157 : constant Version_32 := 16#beb4b171#;
   pragma Export (C, u00157, "system__stream_attributesS");
   u00158 : constant Version_32 := 16#d998b4f3#;
   ...
   u00160 : constant Version_32 := 16#61e84971#;
   pragma Export (C, u00160, "system__fat_fltS");
   u00161 : constant Version_32 := 16#47da407c#;
   pragma Export (C, u00161, "system__fat_lfltS");
   u00162 : constant Version_32 := 16#3d0aee96#;
   pragma Export (C, u00162, "system__fat_llfS");
   u00163 : constant Version_32 := 16#32fdb361#;
   pragma Export (C, u00163, "system__file_attributesS");
   u00164 : constant Version_32 := 16#09793772#;
   pragma Export (C, u00164, "system__os_constantsS");
   u00165 : constant Version_32 := 16#ee52fa88#;
   pragma Export (C, u00165, "system__finalization_mastersB");
   u00166 : constant Version_32 := 16#2489a36e#;
   ...
   u00168 : constant Version_32 := 16#99e1245a#;
   pragma Export (C, u00168, "system__storage_poolsS");
   u00169 : constant Version_32 := 16#8f8e85c2#;
   pragma Export (C, u00169, "system__regexpB");
   u00170 : constant Version_32 := 16#81e831d1#;
   pragma Export (C, u00170, "system__regexpS");
   u00171 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00171, "ada__float_text_ioB");
   u00172 : constant Version_32 := 16#495f738b#;
   pragma Export (C, u00172, "ada__float_text_ioS");
   u00173 : constant Version_32 := 16#a621ddec#;
   pragma Export (C, u00173, "system__img_fltS");
   u00174 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00174, "system__float_controlB");
   u00175 : constant Version_32 := 16#4226d521#;
   pragma Export (C, u00175, "system__float_controlS");
   u00176 : constant Version_32 := 16#2549028f#;
   pragma Export (C, u00176, "system__img_utilB");
   u00177 : constant Version_32 := 16#c9a0e932#;
   pragma Export (C, u00177, "system__img_utilS");
   u00178 : constant Version_32 := 16#7a258c58#;
   pragma Export (C, u00178, "system__powten_fltS");
   u00179 : constant Version_32 := 16#b21210e0#;
   pragma Export (C, u00179, "system__img_lfltS");
   u00180 : constant Version_32 := 16#ea896312#;
   pragma Export (C, u00180, "system__img_lluS");
   u00181 : constant Version_32 := 16#a1d642dc#;
   pragma Export (C, u00181, "system__powten_lfltS");
   u00182 : constant Version_32 := 16#ee24b312#;
   pragma Export (C, u00182, "system__img_llfS");
   u00183 : constant Version_32 := 16#9dd1b61e#;
   pragma Export (C, u00183, "system__powten_llfS");
   u00184 : constant Version_32 := 16#daeb2f58#;
   pragma Export (C, u00184, "system__val_fltS");
   u00185 : constant Version_32 := 16#07cab9e4#;
   pragma Export (C, u00185, "system__exn_fltS");
   u00186 : constant Version_32 := 16#7f0e6534#;
   pragma Export (C, u00186, "system__val_lfltS");
   u00187 : constant Version_32 := 16#b98b583d#;
   pragma Export (C, u00187, "system__exn_lfltS");
   u00188 : constant Version_32 := 16#241739fa#;
   pragma Export (C, u00188, "system__val_llfS");
   u00189 : constant Version_32 := 16#9425984d#;
   pragma Export (C, u00189, "system__exn_llfS");
   u00190 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00190, "ada__integer_text_ioB");
   u00191 : constant Version_32 := 16#5e9ebd8f#;
   pragma Export (C, u00191, "ada__integer_text_ioS");
   u00192 : constant Version_32 := 16#6b2d15e3#;
   pragma Export (C, u00192, "system__img_biuS");
   u00193 : constant Version_32 := 16#2673d23d#;
   pragma Export (C, u00193, "system__img_llbS");
   u00194 : constant Version_32 := 16#98c6c945#;
   pragma Export (C, u00194, "system__img_lliS");
   u00195 : constant Version_32 := 16#5182274f#;
   pragma Export (C, u00195, "system__img_lllbS");
   u00196 : constant Version_32 := 16#f316ccbd#;
   pragma Export (C, u00196, "system__img_llliS");
   u00197 : constant Version_32 := 16#5bf63e43#;
   pragma Export (C, u00197, "system__img_lllwS");
   u00198 : constant Version_32 := 16#7a41a736#;
   pragma Export (C, u00198, "system__img_llwS");
   u00199 : constant Version_32 := 16#54f7aed1#;
   pragma Export (C, u00199, "system__img_wiuS");
   u00200 : constant Version_32 := 16#40199964#;
   pragma Export (C, u00200, "system__val_intS");
   u00201 : constant Version_32 := 16#5b7e5917#;
   pragma Export (C, u00201, "system__val_unsS");
   u00202 : constant Version_32 := 16#3738e9f5#;
   pragma Export (C, u00202, "system__val_llliS");
   u00203 : constant Version_32 := 16#4f0fea27#;
   pragma Export (C, u00203, "system__val_llluS");
   u00204 : constant Version_32 := 16#0b68e88b#;
   pragma Export (C, u00204, "pack_demineurB");
   u00205 : constant Version_32 := 16#a18b5af8#;
   pragma Export (C, u00205, "pack_demineurS");
   u00206 : constant Version_32 := 16#51e8f7c0#;
   pragma Export (C, u00206, "aleatoireB");
   u00207 : constant Version_32 := 16#5ebf4653#;
   pragma Export (C, u00207, "aleatoireS");
   u00208 : constant Version_32 := 16#d9e9756e#;
   pragma Export (C, u00208, "calendarS");
   u00209 : constant Version_32 := 16#92ebd951#;
   pragma Export (C, u00209, "system__arith_64B");
   u00210 : constant Version_32 := 16#8e65a9dc#;
   pragma Export (C, u00210, "system__arith_64S");
   u00211 : constant Version_32 := 16#f2c63a02#;
   pragma Export (C, u00211, "ada__numericsS");
   u00212 : constant Version_32 := 16#174f5472#;
   pragma Export (C, u00212, "ada__numerics__big_numbersS");
   u00213 : constant Version_32 := 16#8a38e3f7#;
   pragma Export (C, u00213, "system__val_enum_8S");
   u00214 : constant Version_32 := 16#1982dcd0#;
   pragma Export (C, u00214, "system__memoryB");
   u00215 : constant Version_32 := 16#f95ea4cd#;
