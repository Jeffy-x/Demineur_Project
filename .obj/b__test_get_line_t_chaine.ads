...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_get_line_t_chaine" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5ad73f44#;
   pragma Export (C, u00001, "test_get_line_t_chaineB");
