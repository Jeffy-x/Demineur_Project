...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_charger_sauvegarde" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b2fdb1ed#;
   pragma Export (C, u00001, "test_charger_sauvegardeB");
