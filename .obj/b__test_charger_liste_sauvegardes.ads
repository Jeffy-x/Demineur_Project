...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_charger_liste_sauvegardes" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#dbd6381c#;
   pragma Export (C, u00001, "test_charger_liste_sauvegardesB");
   ...
   --  pack_demineur%s
   --  pack_demineur%b
   --  test_charger_liste_sauvegardes%b
